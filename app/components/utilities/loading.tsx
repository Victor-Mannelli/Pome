  ...
  return (
    <div className="fixed inset-0 z-[19] w-full h-screen flex items-center justify-center bg-black">
      ...
      {/* <motion.svg
        ...
        className="relative w-1/3 md:w-[10%]"
        initial={{ pathLength: 0 }}
        animate={{ rotate: [0, 360], pathLength: 1 }}
      ...
      <motion.img
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-loading-logo-width md:w-[4%] h-auto z-[50]"
        // src=""
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
